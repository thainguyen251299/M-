...
class ExtraField extends \Chamilo\CoreBundle\Entity\ExtraField implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getValueForItem($itemId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getValueForItem', [$itemId]);

        return parent::getValueForItem($itemId);
    }
    ...
    public function getValueForEachItem()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getValueForEachItem', []);

        return parent::getValueForEachItem();
    }
